#!/bin/bash
#SBATCH --partition=shortq,defq,devq
#SBATCH --nodes=1
...
delf="0.1"
run_mode=3
fname="Noise_N512_FOV1.000" #"Lightcone_N512_FOV1.0000"
#fname2="_ds0.016905_div00.00_pv1_oneevent0_lcon1"
fov="1.0" 
pix_side="512"
telescope="SKA"
field="EOR0"
telescope_model="SKA_central_area_Rev3"
max_bl=3400
workdir="./"
weighting="natural"
...
singularity exec --nv /gpfs01/software/oskar-2.8.3/singularity/OSKAR-2.8.3-Python3.sif python3 image.py $options
...
rm -rf ${fname2}_${telescope}_${telescope_model}_${field}_${fov}_${pix_side}${ms}
echo "${fname2}_${telescope}_${telescope_model}_${field}_${fov}_${pix_side}${ms}"
